...
import 'package:subject_lift_kit/gen/messages.g.dart';

export 'gen/messages.g.dart' show SegmentationResult;
...
class SubjectLiftKit {
  ...
  static Future<SegmentationResult> extractForeground(
  ...
  static Future<bool> isSupported() async {
    try {
      ...
      final result = await _api.extractForeground(
        ImageData(imageBytes: testImage),
      );
